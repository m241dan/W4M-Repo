...
#define MAX_STRING_LENGTH	 (MIL*2*4) /* buf */
...
#define CLASS_TERASKASI	    4
#define CLASS_BLADEMASTER   5
#define CLASS_PALADIN	    6
#define CLASS_BARBARIAN	    7 /* 7-7-96 SB */
#define CLASS_DRUID	    8 /* 7-7-96 SB */
#define CLASS_SHADOW	    9
#define CLASS_WRAITH	   10
#define CLASS_LICH	   11
#define CLASS_THIEF        12

#define CLASS_VAMPIRE      99
#define CLASS_MAGE         98
#define CLASS_CLERIC       97
...
extern CMDTYPE *command_hash[127];
